...
public class KafkaConfig {
    ...
    public Map<String, Object> receiverProperties() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, new TextXPath(settings, "//groupId").toString());
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, new TextXPath(settings, "//keyDeserializer").toString());
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, new TextXPath(settings, "//valueDeserializer").toString());
        props.put("spring.json.trusted.packages", new TextXPath(settings, "//trustedPackages").toString());
        return props;
    }
